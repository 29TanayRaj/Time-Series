...
- **Definition**:
  - Rather than using the past values of the forecast variable in a regression, an MA model uses the past errors in a regression-like model. If the model uses last $$q$$ errors, it is called an MA(q) model.
...
An MA model is suitable for an irregular component.

### 3. Auto-Regressive Moving Average: ARMA(p,q)
- **Definition**:
  - This is the combination of both auto-regressive and moving average models.
